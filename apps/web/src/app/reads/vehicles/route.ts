...
/**
 * GET /reads/vehicles — the vehicle search, cancellable (P1-32-PRE-OD-READ).
 *
...
export function GET(request: Request): Promise<Response> {
  return serveBrowserRead(request, vehicleSearchQuery, (query, signal) =>
    readVehicleSearch(...vehicleSearchArgs(query), signal)
  );
}
