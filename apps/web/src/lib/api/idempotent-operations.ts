 ...
 *
 * Currently approval 17, export 2, financial 15, none 217, privileged 233, security 14.
 *
...
/** Every operation the contract publishes. 498 of them. */
export const PUBLISHED_OPERATIONS: readonly PublishedOperation[] = Object.freeze([
  ...
  {
    template: '/auth/working-context',
    method: 'GET',
    operationId: 'iam.working-context-read',
    idempotent: false,
    auditClass: 'none',
  },
  {
  ...
  },
  {
    ...
    method: 'GET',
    operationId: 'ovw.dashboard-summary-read',
    idempotent: false,
    auditClass: 'none',
  },
  {
  ...
  },
  {
    ...
    method: 'GET',
    operationId: 'sal.delivery-readiness-list',
    idempotent: false,
    auditClass: 'none',
  },
  {
  ...
  },
  {
    ...
    method: 'GET',
    operationId: 'inv.opening-batch-list',
    idempotent: false,
    auditClass: 'none',
  },
  {
  ...
  {
    template: '/opening-inventory-batches/{batchId}',
    method: 'GET',
    operationId: 'inv.opening-batch-read',
    idempotent: false,
    auditClass: 'none',
  },
  {
  ...
  },
  {
    ...
    method: 'GET',
    operationId: 'inv.part-issue-list',
    idempotent: false,
    auditClass: 'none',
  },
  {
  ...
  {
    template: '/platform/audit-events',
    method: 'GET',
    operationId: 'platform.audit-search',
    idempotent: false,
    auditClass: 'none',
  },
  {
  ...
  {
    template: '/platform/organizations/{tenantId}',
    method: 'GET',
    operationId: 'platform.organization-detail',
    idempotent: false,
    auditClass: 'none',
  },
  {
    template: '/platform/organizations/{tenantId}/administrators',
    method: 'POST',
    operationId: 'platform.organization-administrator-invite',
    idempotent: true,
    auditClass: 'privileged',
  },
  {
    template: '/platform/organizations/{tenantId}/branches',
    method: 'POST',
    operationId: 'platform.organization-branch-create',
    idempotent: true,
    auditClass: 'privileged',
  },
  {
    template: '/platform/organizations/{tenantId}/charges',
    method: 'GET',
    operationId: 'platform.charge-list',
    idempotent: false,
    auditClass: 'none',
  },
  {
    template: '/platform/organizations/{tenantId}/charges',
    method: 'POST',
    operationId: 'platform.charge-record',
    idempotent: true,
    auditClass: 'privileged',
  },
  {
    template: '/platform/organizations/{tenantId}/charges/{chargeId}/void',
    method: 'POST',
    operationId: 'platform.charge-void',
    idempotent: true,
    auditClass: 'privileged',
  },
  {
    template: '/platform/organizations/{tenantId}/companies',
    method: 'POST',
    operationId: 'platform.organization-company-create',
    idempotent: true,
    auditClass: 'privileged',
  },
  {
    template: '/platform/organizations/{tenantId}/receipts',
    method: 'POST',
    operationId: 'platform.receipt-record',
    idempotent: true,
    auditClass: 'privileged',
  },
  {
  ...
  {
    template: '/platform/organizations/{tenantId}/subscriptions',
    method: 'POST',
    operationId: 'platform.subscription-assign',
    idempotent: true,
    auditClass: 'privileged',
  },
  {
    template: '/platform/organizations/{tenantId}/subscriptions/{subscriptionId}/cancellation',
    method: 'POST',
    operationId: 'platform.subscription-cancel',
    idempotent: true,
    auditClass: 'privileged',
  },
  {
    template: '/platform/plans',
    method: 'GET',
    operationId: 'platform.plan-list',
    idempotent: false,
    auditClass: 'none',
  },
  {
    template: '/platform/plans',
    method: 'POST',
    operationId: 'platform.plan-create',
    idempotent: true,
    auditClass: 'privileged',
  },
  {
    template: '/platform/plans/{planId}',
    method: 'PATCH',
    operationId: 'platform.plan-update',
    idempotent: true,
    auditClass: 'privileged',
  },
  {
    template: '/platform/session',
    method: 'GET',
    operationId: 'platform.session-read',
    idempotent: false,
    auditClass: 'none',
  },
  {
    ...
    method: 'GET',
    operationId: 'platform.statistics-read',
    idempotent: false,
    auditClass: 'none',
  },
  {
  ...
  {
    template: '/report-configurations',
    method: 'GET',
    operationId: 'rpt.report-configuration-list',
    idempotent: false,
    auditClass: 'none',
  },
  {
    template: '/report-configurations',
    method: 'POST',
    operationId: 'rpt.report-configuration-create',
    idempotent: true,
    auditClass: 'privileged',
  },
  {
    template: '/report-configurations/{configurationId}',
    method: 'GET',
    operationId: 'rpt.report-configuration-read',
    idempotent: false,
    auditClass: 'none',
  },
  {
    template: '/report-configurations/{configurationId}',
    method: 'PATCH',
    operationId: 'rpt.report-configuration-update',
    idempotent: false,
    auditClass: 'privileged',
  },
  {
    template: '/report-configurations/{configurationId}/status',
    method: 'POST',
    operationId: 'rpt.report-configuration-status-set',
    idempotent: true,
    auditClass: 'privileged',
  },
  {
    template: '/report-configurations/{configurationId}/versions',
    method: 'POST',
    operationId: 'rpt.report-configuration-version-create',
    idempotent: true,
    auditClass: 'privileged',
  },
  {
    template: '/report-configurations/{configurationId}/versions/{versionId}/publish',
    method: 'POST',
    operationId: 'rpt.report-configuration-version-publish',
    idempotent: false,
    auditClass: 'privileged',
  },
  {
  ...
  {
    template: '/reports/{reportCode}:export',
    method: 'POST',
  ...
  {
    template: '/reports/{reportCode}/rows',
    method: 'GET',
    operationId: 'rpt.report-run',
    idempotent: false,
    auditClass: 'none',
  },
  {
  ...
  {
    template: '/stock-transfer-settlements',
    method: 'GET',
    operationId: 'inv.stock-transfer-settlement-list',
    idempotent: false,
    auditClass: 'none',
  },
  {
    template: '/stock-transfer-settlements/{settlementId}',
    method: 'GET',
    operationId: 'inv.stock-transfer-settlement-read',
    idempotent: false,
    auditClass: 'none',
  },
  {
  ...
  {
    template: '/warranties/{warrantyId}/status-history',
    method: 'GET',
    operationId: 'wty.warranty-status-history',
    idempotent: false,
    auditClass: 'none',
  },
  {
