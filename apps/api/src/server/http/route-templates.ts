...
export const ROUTE_TEMPLATES = Object.freeze([
  ...
  '/delivery-checklist-templates/{templateId}',
  ...
  '/goods-receipts/{receiptId}/posting',
  '/health/live',
  '/health/ready',
  '/iam/approval-limits',
  ...
  '/inventory-alerts/aged-in-transit',
  '/inventory-alerts/count-discrepancies',
  '/inventory-alerts/low-stock',
  '/inventory-alerts/unusual-consumption',
  ...
  '/items/{itemId}/internal-barcode',
  '/items/{itemId}/label',
  '/items/{itemId}/sale-prices',
  '/jobs',
  '/jobs/{jobId}',
  ...
  '/jobs/{jobId}/work-logs',
  '/labor-sessions/{sessionId}/corrections',
  '/labor-sessions/{sessionId}/stop',
  '/material-exceptions/{exceptionId}/decision',
  '/material-requests/{requestId}/cancellation',
  '/material-requests/{requestId}/closure',
  '/material-requirements',
  '/material-requirements/{requirementId}',
  '/material-requirements/{requirementId}/approval',
  '/material-requirements/{requirementId}/cancellation',
  '/material-requirements/{requirementId}/exceptions',
  '/material-requirements/{requirementId}/recheck',
  '/message-templates',
  ...
  '/org/companies/{companyId}/status',
  '/org/departments',
  '/org/departments/{departmentId}',
  '/org/employees',
  '/org/employees/{employeeId}',
  '/org/employees/{employeeId}/status',
  '/org/tenant',
  ...
  '/platform/organizations/{tenantId}/administrators',
  '/platform/organizations/{tenantId}/branches',
  '/platform/organizations/{tenantId}/charges',
  '/platform/organizations/{tenantId}/charges/{chargeId}/void',
  '/platform/organizations/{tenantId}/companies',
  '/platform/organizations/{tenantId}/receipts',
  '/platform/organizations/{tenantId}/status',
  '/platform/organizations/{tenantId}/subscriptions',
  '/platform/organizations/{tenantId}/subscriptions/{subscriptionId}/cancellation',
  '/platform/plans',
  ...
  '/quotation-revisions/{revisionId}',
  ...
  '/report-configurations/{configurationId}',
  '/report-configurations/{configurationId}/status',
  '/report-configurations/{configurationId}/versions',
  '/report-configurations/{configurationId}/versions/{versionId}/publish',
  '/reports',
  '/reports/{reportCode}',
  ...
  '/stock-adjustments',
  '/stock-adjustments/{adjustmentId}/approval',
  '/stock-availability',
  '/stock-counts',
  '/stock-counts/{countId}',
  '/stock-counts/{countId}/cancellation',
  '/stock-counts/{countId}/lines/{itemId}',
  ...
  '/unit-conversions',
  '/unit-conversions/{conversionId}/retirement',
  '/units-of-measure',
  ...
  '/vehicle-fluid-specifications',
  '/vehicle-fluid-specifications/{specificationId}/confirmation',
  '/vehicle-fluid-specifications/{specificationId}/retirement',
  '/vehicles',
  '/vehicles/{vehicleId}',
  ...
  '/warranty-policies/{policyId}/coverage-windows/{coverageId}/status',
  '/warranty-policies/{policyId}/status',
  ...
  '/work-orders/{workOrderId}/delivery',
  '/work-orders/{workOrderId}/evidence',
  ...
  '/work-orders/{workOrderId}/part-issues',
  '/work-orders/{workOrderId}/quality-controls',
  '/work-orders/{workOrderId}/quotations',
