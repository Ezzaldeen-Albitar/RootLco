...
| Area                                           | Routes                                                                                                                                                                                                                                                                                                                                                                                        | a–i       |
| ---------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------- |
| Inventory                                      | `/inventory`, `/inventory/items/[itemId]`, `/inventory/transfers`, `/inventory/goods-receipts`, `/inventory/adjustments`, `/inventory/counts`, `/inventory/customer-returns`, `/inventory/counter-sales`, `/inventory/labels`, `/inventory/unit-conversions`, `/inventory/vehicle-specifications`, `/inventory/parts`, `/inventory/movements`, `/inventory/opening-stock`, `/inventory/setup` | not swept |
| Sales and finance                              | `/services`, `/services/[serviceId]`, `/pricing`, `/pricing/[priceListId]`, `/quotations`, `/quotations/[quotationId]`, `/invoices`, `/credit-notes`, `/payments`                                                                                                                                                                                                                             | not swept |
...
3. **A reader for `sal.delivery-list`.** The operation exists, accepts `q` and an optional branch,
