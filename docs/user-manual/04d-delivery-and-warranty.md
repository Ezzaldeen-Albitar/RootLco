...
| "You do not have permission to release a vehicle while money is still owed. Ask your company administrator to release it, or to give you that permission." <!-- delivery.completion.refusedOverride --> | You ticked the override without the authority. The screen no longer prints the internal code for that authority.                                            | Ask your company administrator.                       |
