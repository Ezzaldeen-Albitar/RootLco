...
| 4   | All 19 backend tasks (P1-18-BE-001…019) implemented and mapped to operations                                                                                                 | **Pending** |
...
| 17  | Exact-SHA PostgreSQL 17 clean room from an empty database                                                                                                                    | **Pending** |
