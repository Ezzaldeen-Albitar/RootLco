...
project, and the current tree executes **5040** tests. Both are derived on every
...
**The 5040 is HOSTED, and it is the binding measurement.** It is the output of
...
| Web tier — tests executed                   | 5040  | `--record web`, from the `vitest` JSON report                      |
