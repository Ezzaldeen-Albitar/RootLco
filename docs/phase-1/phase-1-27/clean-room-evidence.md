...
project, and the current tree executes **4864** tests. Both are derived on every
...
**The 4864 is HOSTED, and it is the binding measurement.** It is the output of
...
| Web tier — tests executed                   | 4864  | `--record web`, from the `vitest` JSON report                      |
