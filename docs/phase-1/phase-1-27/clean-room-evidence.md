...
project, and the current tree executes **2669** tests. Both are derived on every
...
**The 2669 is local, and it is the binding measurement.** It is the output of
...
| Web tier — tests executed                   | 2669  | `--record web`, from the `vitest` JSON report                      |
