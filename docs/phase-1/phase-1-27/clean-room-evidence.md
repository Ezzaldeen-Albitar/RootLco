...
project, and the current tree executes **4020** tests. Both are derived on every
...
**The 4020 is local, and it is pending attestation by this pull request's hosted
...
| Web tier — tests executed                   | 4020  | `--record web`, from the `vitest` JSON report                      |
