...
project, and the current tree executes **5288** tests. Both are derived on every
...
**The 5288 is HOSTED, and it is the binding measurement.** It is the output of
...
| Web tier — tests executed                   | 5288  | `--record web`, from the `vitest` JSON report                      |
