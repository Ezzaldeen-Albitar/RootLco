...
project, and the current tree executes **5201** tests. Both are derived on every
...
**The 5201 is HOSTED, and it is the binding measurement.** It is the output of
...
| Web tier — tests executed                   | 5201  | `--record web`, from the `vitest` JSON report                      |
