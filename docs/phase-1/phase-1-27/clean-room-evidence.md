...
project, and the current tree executes **3544** tests. Both are derived on every
...
**The 3544 is HOSTED, and it is the binding measurement.** It is the output of
...
| Web tier — tests executed                   | 3544  | `--record web`, from the `vitest` JSON report                      |
