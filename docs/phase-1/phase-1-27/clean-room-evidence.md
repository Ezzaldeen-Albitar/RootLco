...
project, and the current tree executes **5211** tests. Both are derived on every
...
**The 5211 is HOSTED, and it is the binding measurement.** It is the output of
...
| Web tier — tests executed                   | 5211  | `--record web`, from the `vitest` JSON report                      |
