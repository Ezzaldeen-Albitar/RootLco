...
project, and the current tree executes **4869** tests. Both are derived on every
...
**The 4869 is HOSTED, and it is the binding measurement.** It is the output of
...
| Web tier — tests executed                   | 4869  | `--record web`, from the `vitest` JSON report                      |
