...
project, and the current tree executes **3612** tests. Both are derived on every
...
**The 3612 is local, and it is pending attestation by this pull request's hosted
...
| Web tier — tests executed                   | 3612  | `--record web`, from the `vitest` JSON report                      |
