...
project, and the current tree executes **5769** tests. Both are derived on every
...
**The 5769 is HOSTED, and it is the binding measurement.** It is the output of
...
| Web tier — tests executed                   | 5769  | `--record web`, from the `vitest` JSON report                      |
