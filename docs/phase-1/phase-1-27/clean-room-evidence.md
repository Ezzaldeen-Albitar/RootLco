...
project, and the current tree executes **3490** tests. Both are derived on every
...
**The 3490 is HOSTED, and it is the binding measurement.** It is the output of
...
| Root unit tier — tests executed             | 3226  | `--record unit`, from the `vitest` JSON report                     |
