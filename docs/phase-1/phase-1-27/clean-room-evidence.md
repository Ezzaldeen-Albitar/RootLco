...
project, and the current tree executes **5743** tests. Both are derived on every
...
**The 5743 is HOSTED, and it is the binding measurement.** It is the output of
...
| Web tier — tests executed                   | 5743  | `--record web`, from the `vitest` JSON report                      |
