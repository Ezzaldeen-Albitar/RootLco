...
project, and the current tree executes **3531** tests. Both are derived on every
...
**The 3531 is HOSTED, and it is the binding measurement.** It is the output of
...
| Web tier — tests executed                   | 3531  | `--record web`, from the `vitest` JSON report                      |
