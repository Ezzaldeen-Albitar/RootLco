...
project, and the current tree executes **4977** tests. Both are derived on every
...
**The 4977 is HOSTED, and it is the binding measurement.** It is the output of
...
| Web tier — tests executed                   | 4977  | `--record web`, from the `vitest` JSON report                      |
