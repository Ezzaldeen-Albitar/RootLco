...
project, and the current tree executes **5223** tests. Both are derived on every
...
**The 5223 is HOSTED, and it is the binding measurement.** It is the output of
...
| Web tier — tests executed                   | 5223  | `--record web`, from the `vitest` JSON report                      |
