...
project, and the current tree executes **5673** tests. Both are derived on every
...
**The 5673 is HOSTED, and it is the binding measurement.** It is the output of
...
| Root unit tier — tests executed             | 3713  | `--record unit`, from the `vitest` JSON report                     |
