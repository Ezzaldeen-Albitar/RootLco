...
project, and the current tree executes **5069** tests. Both are derived on every
...
**The 5069 is HOSTED, and it is the binding measurement.** It is the output of
...
| Web tier — tests executed                   | 5069  | `--record web`, from the `vitest` JSON report                      |
