...
project, and the current tree executes **5164** tests. Both are derived on every
...
**The 5164 is HOSTED, and it is the binding measurement.** It is the output of
...
| Web tier — tests executed                   | 5164  | `--record web`, from the `vitest` JSON report                      |
