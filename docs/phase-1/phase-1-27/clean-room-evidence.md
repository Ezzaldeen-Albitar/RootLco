...
project, and the current tree executes **3619** tests. Both are derived on every
...
**The 3619 is local, and it is pending attestation by this pull request's hosted
...
| Web tier — tests executed                   | 3619  | `--record web`, from the `vitest` JSON report                      |
