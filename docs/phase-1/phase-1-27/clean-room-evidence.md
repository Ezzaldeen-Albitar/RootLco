...
project, and the current tree executes **5300** tests. Both are derived on every
...
**The 5300 is HOSTED, and it is the binding measurement.** It is the output of
...
| Web tier — tests executed                   | 5300  | `--record web`, from the `vitest` JSON report                      |
