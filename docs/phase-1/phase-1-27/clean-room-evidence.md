...
project, and the current tree executes **5359** tests. Both are derived on every
...
**The 5359 is HOSTED, and it is the binding measurement.** It is the output of
...
| Web tier — tests executed                   | 5359  | `--record web`, from the `vitest` JSON report                      |
