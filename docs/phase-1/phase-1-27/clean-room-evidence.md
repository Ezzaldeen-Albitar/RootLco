...
project, and the current tree executes **5443** tests. Both are derived on every
...
**The 5443 is HOSTED, and it is the binding measurement.** It is the output of
...
| Web tier — tests executed                   | 5443  | `--record web`, from the `vitest` JSON report                      |
