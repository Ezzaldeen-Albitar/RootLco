...
project, and the current tree executes **2866** tests. Both are derived on every
...
**The 2866 is local, and it is the binding measurement.** It is the output of
...
| Web tier — tests executed                   | 2866  | `--record web`, from the `vitest` JSON report                      |
