...
project, and the current tree executes **5349** tests. Both are derived on every
...
**The 5349 is HOSTED, and it is the binding measurement.** It is the output of
...
| Web tier — tests executed                   | 5349  | `--record web`, from the `vitest` JSON report                      |
