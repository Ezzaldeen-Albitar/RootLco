...
project, and the current tree executes **5842** tests. Both are derived on every
...
**The 5842 is HOSTED, and it is the binding measurement.** It is the output of
...
| Web tier — tests executed                   | 5842  | `--record web`, from the `vitest` JSON report                      |
