...
project, and the current tree executes **5604** tests. Both are derived on every
...
**The 5604 is HOSTED, and it is the binding measurement.** It is the output of
...
| Web tier — tests executed                   | 5604  | `--record web`, from the `vitest` JSON report                      |
