...
| Root unit tier — tests executed             | 3027  | `--record unit`, from the `vitest` JSON report                     |
...
| Migrations on disk                          | 127   | a walk of `supabase/migrations`                                    |
...
| Migrations tracked by git at `HEAD`                  | 127                                         |
