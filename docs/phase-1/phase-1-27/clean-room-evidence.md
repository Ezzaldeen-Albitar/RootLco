...
project, and the current tree executes **4838** tests. Both are derived on every
...
**The 4838 is HOSTED, and it is the binding measurement.** It is the output of
...
| Web tier — tests executed                   | 4838  | `--record web`, from the `vitest` JSON report                      |
