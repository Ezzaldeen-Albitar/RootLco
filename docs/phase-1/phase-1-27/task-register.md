...
| `DO-001` continuous-integration quality gate                                                                        | 15    | `2688635`            | none — a gate over the phase's own source                                                                        | `scripts/ci/check-p1-27-frontend.mjs`, eight rules with a `selfTest()`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
