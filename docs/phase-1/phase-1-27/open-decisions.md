...
| --- | ------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | `scripts/ci/check-p1-27-frontend.mjs`, rule `no-merge-caller`       | Any of `customer-merge`, `vehicle-merge`, a `"/merge"` path literal or a `merge*Action` export, across the **75** files the gate owns, in all three canonical trees                                             |
...
`total: <anything>.length` across all **75** files the gate owns.
