...
| Web unit and component test files                                      | **128**                                                            | derived                                                                    |
...
`validate:p1-27-frontend` reports **145 files across 5 trees, 0 failures**. Of
...
### 6.1 Web unit and component — `apps/web/tests` (128 files, and no case total — `E-03`)
...
<!-- derived: files apps/web/tests = 128 -->
...
<!-- derived: files tests/backend = 122 -->
<!-- derived: files tests/backend:all = 130 -->
