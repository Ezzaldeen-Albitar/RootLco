...
| ---------------------------------------------------------------------- | ------------------------------------------------------------------ | -------------------------------------------------------------------------- |
| Source files under the P1-27 ownership gate                            | **136** (43 feature source + 44 route + 49 adopted reception)      | derived from the gate's own scan roots                                     |
...
| Web unit and component test files                                      | **114**                                                            | derived                                                                    |
...
`validate:p1-27-frontend` reports **136 files across 5 trees, 0 failures**. Of
...
### 6.1 Web unit and component — `apps/web/tests` (114 files, and no case total — `E-03`)
...
<!-- derived: files apps/web/tests = 114 -->
...
<!-- derived: files tests/backend = 116 -->
<!-- derived: files tests/backend:all = 124 -->
