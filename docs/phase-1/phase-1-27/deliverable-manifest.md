...
`validate:p1-27-frontend` reports **160 files across 5 trees, 0 failures**. Of
...
<!-- derived: files supabase/migrations = 151 -->
<!-- derived: files tests/db = 151 -->
<!-- derived: files tests/db:all = 155 -->
...
<!-- derived: files p1-27-frontend-gate = 160 -->
