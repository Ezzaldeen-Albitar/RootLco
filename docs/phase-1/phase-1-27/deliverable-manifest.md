...
| Web unit and component test files                                      | **137**                                                            | derived                                                                    |
...
`validate:p1-27-frontend` reports **153 files across 5 trees, 0 failures**. Of
...
### 6.1 Web unit and component — `apps/web/tests` (137 files, and no case total — `E-03`)
...
<!-- derived: files apps/web/tests = 137 -->
...
<!-- derived: files p1-27-frontend-gate = 153 -->
