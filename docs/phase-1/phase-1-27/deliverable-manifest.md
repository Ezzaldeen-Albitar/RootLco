...
| ---------------------------------------------------------------------- | ------------------------------------------------------------------ | -------------------------------------------------------------------------- |
| Source files under the P1-27 ownership gate                            | **140** (43 feature source + 48 route + 49 adopted reception)      | derived from the gate's own scan roots                                     |
...
| Web unit and component test files                                      | **120**                                                            | derived                                                                    |
...
`validate:p1-27-frontend` reports **140 files across 5 trees, 0 failures**. Of
...
### 6.1 Web unit and component — `apps/web/tests` (120 files, and no case total — `E-03`)
...
<!-- derived: files apps/web/tests = 120 -->
...
<!-- derived: files tests/backend = 118 -->
<!-- derived: files tests/backend:all = 126 -->
