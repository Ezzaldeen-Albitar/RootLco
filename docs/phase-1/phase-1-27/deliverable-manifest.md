...
| ---------------------------------------------------------------------- | ------------------------------------------------------------------ | -------------------------------------------------------------------------- |
| Source files under the P1-27 ownership gate                            | **144** (43 feature source + 52 route + 49 adopted reception)      | derived from the gate's own scan roots                                     |
...
| Web unit and component test files                                      | **126**                                                            | derived                                                                    |
...
`validate:p1-27-frontend` reports **144 files across 5 trees, 0 failures**. Of
...
### 6.1 Web unit and component — `apps/web/tests` (126 files, and no case total — `E-03`)
...
<!-- derived: files apps/web/tests = 126 -->
...
<!-- derived: files tests/backend = 121 -->
<!-- derived: files tests/backend:all = 129 -->
