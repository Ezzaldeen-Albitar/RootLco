...
| Web unit and component test files                                      | **159**                                                            | derived                                                                    |
...
`validate:p1-27-frontend` reports **169 files across 5 trees, 0 failures**. Of
...
### 6.1 Web unit and component — `apps/web/tests` (159 files, and no case total — `E-03`)
...
<!-- derived: files apps/web/tests = 159 -->
...
<!-- derived: files p1-27-frontend-gate = 169 -->
