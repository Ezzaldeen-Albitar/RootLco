...
| Web unit and component test files                                      | **148**                                                            | derived                                                                    |
...
`validate:p1-27-frontend` reports **159 files across 5 trees, 0 failures**. Of
...
### 6.1 Web unit and component — `apps/web/tests` (148 files, and no case total — `E-03`)
...
`148` is recomputed from the tree on every run, here and in §3, and
...
<!-- derived: files p1-27-frontend-gate = 159 -->
