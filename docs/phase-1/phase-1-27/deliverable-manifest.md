...
| Web unit and component test files                                      | **107**                                                            | derived                                                                    |
...
`validate:p1-27-frontend` reports **129 files across 5 trees, 0 failures**. Of
...
### 6.1 Web unit and component — `apps/web/tests` (107 files, and no case total — `E-03`)
...
<!-- derived: files apps/web/tests = 107 -->
...
<!-- derived: files tests/backend = 107 -->
<!-- derived: files tests/backend:all = 115 -->
