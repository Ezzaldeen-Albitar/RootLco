...
| Web unit and component test files                                      | **83**                                                             | derived                                                                    |
...
### 6.1 Web unit and component — `apps/web/tests` (83 files, and no case total — `E-03`)
...
`83` is recomputed from the tree on every run, here and in §3, and
...
<!-- derived: files apps/web/tests = 83 -->
