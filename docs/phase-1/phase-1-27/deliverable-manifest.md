...
| `tests/backend`                                       | **84** test files (89 files in the directory)   | **not run here** — needs a running PostgreSQL                                                                                                                | both halves derived                     |
...
| Current case counts for `tests/backend` (84 files) and `tests/db` (139 files)              | A running local PostgreSQL. The 1636 / 1636 figure is recorded, not re-measured here                                                                                                                                                                                                                                                                                                                                      |
...
| 6   | This manifest §6.4: "`tests/backend` 84 files present", "`tests/db` 139 files present"                                                                                                                                                                                  | **84 and 139 are the _test_ file counts; 89 and 143 files are present.** This row itself said 138 and 142 (`E-09`), and all four numbers are derived now, here and in `risk-register.md` §6.4                                                                                                                   |
...
| Current case counts for `tests/backend` (84 test files) and `tests/db` (139 test files)                | A running local PostgreSQL                                                                                               |
...
<!-- derived: files tests/backend = 84 -->
<!-- derived: files tests/backend:all = 89 -->
