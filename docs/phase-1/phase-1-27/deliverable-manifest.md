...
| Web unit and component test files                                      | **153**                                                            | derived                                                                    |
...
`validate:p1-27-frontend` reports **161 files across 5 trees, 0 failures**. Of
...
### 6.1 Web unit and component — `apps/web/tests` (153 files, and no case total — `E-03`)
...
`153` is recomputed from the tree on every run, here and in §3, and
...
<!-- derived: files apps/web/tests = 153 -->
<!-- derived: files tests/ci = 77 -->
<!-- derived: files scripts/ci = 66 -->
<!-- derived: files apps/web/scripts = 4 -->
<!-- derived: files supabase/migrations = 147 -->
<!-- derived: files tests/db = 150 -->
<!-- derived: files tests/db:all = 154 -->
<!-- derived: files tests/backend = 150 -->
<!-- derived: files tests/backend:all = 159 -->
<!-- derived: files apps/web/src/features/crm = 20 -->
<!-- derived: files apps/web/src/features/vehicles = 23 -->
<!-- derived: files p1-27-frontend-gate = 161 -->
