...
| CI gate scripts under `scripts/ci`                                     | **58** in the directory, **8** introduced or changed by this phase | derived; the eight are the `scripts/ci` rows of §7.1                       |
...
<!-- derived: files tests/ci = 59 -->
<!-- derived: files scripts/ci = 58 -->
