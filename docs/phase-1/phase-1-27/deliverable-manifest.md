...
| 6   | `143 registered · 71 required · 71/71` | `158 registered · 80 required · 80/80` | derived — §7.1                                                      |
...
| `scripts/ci/check-command-coverage.mjs`         | `validate:command-coverage`                          | changed — registry entries | A required command not reachable from `verify:workspaces` **and** not invoked by hosted CI                                                                                                                                                                                                                                                                            | **158 registered · 80 required · 80/80 reachable · 80/80 invoked by hosted CI** — derived |
