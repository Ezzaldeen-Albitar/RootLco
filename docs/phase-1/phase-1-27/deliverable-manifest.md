...
| Web unit and component test files                                      | **139**                                                            | derived                                                                    |
...
`validate:p1-27-frontend` reports **155 files across 5 trees, 0 failures**. Of
...
### 6.1 Web unit and component — `apps/web/tests` (139 files, and no case total — `E-03`)
...
<!-- derived: files apps/web/tests = 139 -->
...
<!-- derived: files p1-27-frontend-gate = 155 -->
