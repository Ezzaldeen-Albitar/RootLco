...
| Web unit and component test files                                      | **105**                                                            | derived                                                                    |
...
`validate:p1-27-frontend` reports **128 files across 5 trees, 0 failures**. Of
...
### 6.1 Web unit and component — `apps/web/tests` (105 files, and no case total — `E-03`)
...
<!-- derived: files apps/web/tests = 105 -->
...
<!-- derived: files tests/backend = 103 -->
<!-- derived: files tests/backend:all = 110 -->
<!-- derived: files apps/web/src/features/crm = 20 -->
<!-- derived: files apps/web/src/features/vehicles = 23 -->
<!-- derived: files p1-27-frontend-gate = 128 -->
