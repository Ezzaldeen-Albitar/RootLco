...
| CI gate scripts under `scripts/ci`                                     | **61** in the directory, **8** introduced or changed by this phase | derived; the eight are the `scripts/ci` rows of §7.1                       |
...
<!-- derived: commands registered = 173 -->
<!-- derived: commands required = 92 -->
<!-- derived: commands reachable = 92 -->
<!-- derived: commands hosted-ci = 92 -->
