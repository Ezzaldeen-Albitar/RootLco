...
| Root CI-contract test files                                            | **35**                                                             | commands 1 and 10                                                          |
| CI gate scripts under `scripts/ci`                                     | **43** in the directory, **7** introduced or changed by this phase | command 1; the six are the `scripts/ci` rows of §7.1                       |
