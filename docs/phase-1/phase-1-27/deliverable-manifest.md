...
| Web unit and component test files                                      | **184**                                                            | derived                                                                    |
...
### 6.1 Web unit and component — `apps/web/tests` (184 files, and no case total — `E-03`)
...
<!-- derived: files apps/web/tests = 184 -->
