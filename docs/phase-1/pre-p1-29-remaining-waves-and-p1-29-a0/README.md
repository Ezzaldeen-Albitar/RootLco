...
| -------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [execution-restart-map.md](execution-restart-map.md)                             | **Read this first when execution resumes.** The provider-response decision point, the seventeen-step B1 closure path, what starts when, and the facts not to rediscover incorrectly. |
