...
| DB-022  | Index / EXPLAIN review                     | `…106000`                                               | [migration classification](../../database/phase-1-6-migration-classification.md) index posture; [object inventory](./crm-object-inventory.md) (79 indexes). Reconciled to the enforced standard P1-03-DB-017: every crm FK now has a non-partial covering index (migration `…106000`) | ✅ Done |
