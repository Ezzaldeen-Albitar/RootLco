...
| SEC-001 | Personal-data classification registry      | `docs/database/crm-personal-data-classification.json`   | `scripts/check-crm-classification.mjs`; 296 cols / 7 restricted / 11 searchable                                                                                                                                      | ✅ Done |
