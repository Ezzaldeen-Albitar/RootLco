...
**Unit-tier subtotal: 278 tests across 9 files.**
...
**Database-tier subtotal: 239 tests across 7 files.**
...
**Backend-tier subtotal: 204 tests across 4 files.**

**P1-15 total: 721 tests across 20 files.**
...
Full run of all three tiers against the working tree of `feature/p1-15-shared-services-backend`,
2026-07-23, on the Supabase CLI stack with migrations 1–117 applied.

| Tier              | Command                | Files   | Tests    | Exit |
| ----------------- | ---------------------- | ------- | -------- | ---- |
| Unit / foundation | `npm test`             | 34      | 678      | 0    |
| Backend           | `npm run test:backend` | 16      | 363      | 0    |
| Database          | `npm run test:db`      | 129     | 1508     | 0    |
| **Total**         |                        | **179** | **2549** |      |
