...
| id         | residual                                                                                                                                                                                                                                                                                                                                                                                 | note                                                                                                                                                                                                                                                                                                                                                                          |
| ---------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **WAVE-B** | Wave B is entirely unbuilt: no `app_platform` role, `iam.platform_grants` and `org.company_status_history` both resolve to NULL. **Its design gate has now been run over revision 4 and DOES NOT PASS** — 0 confirmed critical, **2 confirmed high** from 85 findings across seven lanes.                                                                                                | **Gates Wave C, and therefore BR-02.** Revision 5 is required before implementation may begin, and slice B1 is additionally held by C-B1 below. Both findings are in §9 of `wave-b-control-plane-refutation-register.md`: an INSERT grant on the one history table with no server-stamp trigger, and a migration that grants EXECUTE on a function a later migration creates. |
...
7. **WAVE-B → WAVE-C → BR-02** — blocked. The design gate has now RUN over
   revision 4 and did not pass; revision 5 must close two confirmed high findings,
   and slice B1 additionally needs the B1 escalation to clear.
