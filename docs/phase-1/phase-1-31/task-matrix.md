...
| Task ID       | Task name                                        | State                  | Proving artefact                                                                                                            | Next dependency                                                                                                                             |
| ------------- | ------------------------------------------------ | ---------------------- | --------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- |
| P1-31-SEC-001 | Permission and resolved-scope enforcement        | phase-level incomplete | #360 permission and paired-scope tests; #358 selected backend 17/17; unmerged #363 full DB 1743/1743 and backend seam 28/28 | phase-wide enforcement coverage and acceptance remain unfinished; these are scoped slice proofs                                             |
...
| P1-31-QA-002 | API/contract and error-path coverage     | phase-level incomplete | #360 permission/scope adapter tests; #358 selected backend 17/17; unmerged #363 selected backend 28/28 and full DB 1743/1743                                                                                | phase-wide contract/error coverage and unpublished P-12 remain unfinished                                        |
| P1-31-QA-003 | Tenant/company/branch isolation coverage | phase-level incomplete | #360 paired authorized scope tests; #358 selected backend 17/17; unmerged #363 full DB 1743/1743 and scoped backend seam 28/28                                                                              | phase-wide isolation coverage remains unfinished; per-slice proof is not phase acceptance                        |
...
| P1-31-QA-005 | Regression and evidence packaging        | phase-level incomplete | merged #365 controlled three-assertion/two-teardown failure attribution, full hosted DB 1738/1738 across 144 files, and 51-file external evidence bundle; unmerged #363 full DB 1743/1743 and backend 28/28 | the phase acceptance record required by rule 2 is not complete                                                   |
...
**Sixteen have a merged contribution; P-11 still has its engine in open PR #364.** P-9b remains in open PR #363. P-12 remains not started in this snapshot. No canonical task is closed by a prerequisite merge.
