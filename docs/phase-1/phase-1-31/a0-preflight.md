...
| **P-9**  | Provide a delivery-checklist template writer                | Backend — delivery configuration       | The checklist template and template-item tables are SELECT-only. **PPD-12**. **RESOLVED** by eight operations under /api/v1/delivery-checklist-templates (branch remediation/p1-31-backend-checklist-template-seam, PR #355); see delivery-checklist-template-seam.md and change control CC-14, which records the completion-gate defect this seam measured and did not fix. **P-9b landed** (Owner approval 2026-09-09, branch remediation/p1-31-backend-complete-delivery-template-gate, PR #363): migration 20260909090000_sal_complete_delivery_active_template_gate.sql makes sal.complete_delivery honour active, non-deleted templates and moves the application mirror in lockstep, closing CC-14; see p9b-complete-delivery-template-gate.md                                            | FE-004                                                    |
