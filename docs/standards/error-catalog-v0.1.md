...
| **ERR-CAP-003**  | Plan capacity is below current usage             | 409  | capacity      | No        | conflict | The subscription plan the request would assign declares a ceiling below what the organisation already holds. Reported per kind — `overCapacity` names each one with what is in use and what the new plan would permit — because an operator told only that a plan is too small would correct one kind and be refused for the next. An operator who states a reason may accept it deliberately; nothing is deleted and the creation triggers go on refusing anything new.                                                                                                                                                                                                                                                                                                                                       |
