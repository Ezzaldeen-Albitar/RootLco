...
| ------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------ |
| **FKs on `shared.number_sequences` scope columns — RESOLVED 2026-07-17** | The Phase 1-2 gap is closed: Phase 1-3 created `org.*` and attached the composite FKs (`20260717106000_shared_number_sequences_org_fks.sql`), making sequence scope structural.  | Resolved.                                                                                                    |
