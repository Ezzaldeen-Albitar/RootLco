...
| Append-only / no-runtime-DELETE posture                     | Practised (migration `0003` grants; verified by the 68-test suite passing on 2026-07-16, including the append-only fixture denying runtime UPDATE/DELETE and RESTRICT FK behaviour) |
