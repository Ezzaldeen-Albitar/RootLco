...
const EXPECTED_ERROR_CONTRACTS = [
  ...
  { code: 'ERR-IAM-003', status: 422, owner: 'authorization', class: 'security', retryable: false },
  { code: 'ERR-IAM-004', status: 422, owner: 'validation', class: 'client', retryable: false },
  ...
  { code: 'ERR-INV-001', status: 409, owner: 'transition', class: 'conflict', retryable: false },
...
const EXPECTED_AUDIT_ACTIONS = [
  ...
  // Intake configuration catalogues, management half (P1-27-INT-018). Sorted
  // after `apt.appointment.*` because `.` (0x2E) precedes `_` (0x5F).
  'apt.appointment_type.created',
  'apt.appointment_type.renamed',
  'apt.appointment_type.status_changed',
  'apt.cancellation_reason.created',
  'apt.cancellation_reason.renamed',
  'apt.cancellation_reason.status_changed',
  'apt.source_channel.created',
  'apt.source_channel.renamed',
  'apt.source_channel.status_changed',
  ...
  'inv.goods_receipt.created',
  'inv.goods_receipt.posted',
  'inv.item.created',
  'inv.item_barcode.assigned',
  ...
  'inv.material_exception.requested',
  'inv.material_request.cancelled',
  'inv.material_request.closed',
  'inv.material_requirement.approved',
  'inv.material_requirement.cancelled',
  'inv.material_requirement.rechecked',
  'inv.material_requirement.rejected',
  'inv.material_requirement.requested',
  ...
  'inv.sales_return.received',
  'inv.stock.damaged',
  'inv.stock.reservation_released',
  'inv.stock.reserved',
  'inv.stock_adjustment.approved',
  'inv.stock_adjustment.rejected',
  'inv.stock_adjustment.requested',
  'inv.stock_count.cancelled',
  'inv.stock_count.line_recorded',
  'inv.stock_count.opened',
  'inv.stock_count.reconciled',
  'inv.stock_location.created',
  'inv.stock_transfer.cancelled',
  'inv.stock_transfer.discrepancy_resolved',
  'inv.stock_transfer.dispatched',
  'inv.stock_transfer.received',
  'inv.stock_transfer.write_off_approved',
  'inv.stock_transfer.write_off_rejected',
  'inv.unit_conversion.retired',
  'inv.unit_conversion.set',
  'inv.vehicle_specification.confirmed',
  'inv.vehicle_specification.recorded',
  'inv.vehicle_specification.retired',
  'org.branch.created',
  ...
  // P1-32-PRE-023/024 — the Platform Owner Console.
  ...
  'rec.capture_policy.set',
  'rec.damage_map_template.created',
  'rec.damage_map_template.status_changed',
  'rec.damage_map_template.version_published',
  // Intake configuration catalogues, management half (P1-27-INT-018).
  'rec.fuel_level.created',
  'rec.fuel_level.renamed',
  'rec.fuel_level.status_changed',
  'rec.reception.approved',
  'rec.reception.authorization_recorded',
  'rec.reception.capture_evidence_bound',
  'rec.reception.capture_evidence_finalized',
  'rec.reception.capture_requirement_overridden',
  ...
  'rec.reception.signature_lifecycle_recorded',
  'rec.reception.signature_recorded',
  'rec.refusal_reason.created',
  'rec.refusal_reason.renamed',
  'rec.refusal_reason.status_changed',
  'rec.visit_reason.created',
  'rec.visit_reason.renamed',
  'rec.visit_reason.status_changed',
  ...
  'rpt.report_configuration.version_created',
  'rpt.report_configuration.version_published',
  'sal.counter_sale.created',
  ...
  'svc.discount_threshold.versioned',
  'svc.price_list.created',
  'svc.price_list_assignment.created',
  'svc.price_list_version.created',
  'svc.price_list_version.published',
  'svc.price_rule.recorded',
  'svc.service.updated',
  'svc.service_category.updated',
  'svc.service_version.drafted',
  ...
  'wo.job.blocker_raised',
  'wo.job.blocker_resolved',
  'wo.job.created',
