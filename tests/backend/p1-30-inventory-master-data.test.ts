...
describe('declarations', () => {
  ...
  it('MD-B1 the administrator bundle now holds inv.adjustment.approve', () => {
    ...
    // and 75 since P1-31 P-10 published the warranty policy write surface and
    // carried `wty.policy.manage` with it (CC-01, now closed); the two inventory
    // codes this case owns are unaffected by all three.
