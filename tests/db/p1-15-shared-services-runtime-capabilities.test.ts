...
describe('P1-15 / global security posture', () => {
  it('the repository declares exactly 144 migrations, with the newest fifteen named', () => {
    ...
    expect(files.at(-3)).toBe('20260916090000_platform_console_read_graph.sql');
    expect(files.at(-2)).toBe('20260916091000_org_subscription_commerce.sql');
    expect(files.at(-1)).toBe('20260916092000_org_subscription_billing.sql');
  });
