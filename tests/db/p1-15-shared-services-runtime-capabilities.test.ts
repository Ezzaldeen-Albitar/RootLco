...
describe('P1-15 / global security posture', () => {
  it('the repository declares exactly 143 migrations, with the newest fourteen named', () => {
    ...
    // pair, and two more with the P1-32 friendly-search pair. Sliding it would
    ...
    // tree instead: fourteen names below, 143 files.
    ...
    // 142 is P1-32 friendly search: shared.fold_digits and shared.fold_search_text,
