...
describe('P1-15 / global security posture', () => {
  ...
  it('both new permission codes exist exactly once and the catalog totals 92', async () => {
    ...
    // 71 at P1-15; P1-19 added 21 codes across wo/tech/dia/qms (see
    ...
    expect(Number(total.rows[0]?.n)).toBe(92);
  });
