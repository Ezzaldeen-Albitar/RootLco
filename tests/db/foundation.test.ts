...
const ALLOWED_ROUTINES = new Set([
  ...
  'inv.approve_material_requirement',
  'inv.approve_opening_batch',
  'inv.add_item_identifier',
  'inv.apply_transfer_settlement',
  'inv.assign_internal_barcode',
  'inv.cancel_material_requirement',
  'inv.cancel_stock_count',
  'inv.cancel_transfer',
  'inv.confirm_vehicle_fluid_specification',
  'inv.consume_reservation',
  'inv.convert_item_quantity',
  'inv.create_material_request',
  'inv.decide_material_exception',
  'inv.decide_transfer_write_off',
  'inv.derive_material_requirement',
  'inv.dispatch_transfer',
  'inv.ensure_transit_location',
  'inv.expire_reservations',
  'inv.finish_material_request',
  'inv.free_reservations_for_loss',
  'inv.govern_work_order_draw',
  'inv.guard_adjustment_approval',
  'inv.guard_goods_receipt_status',
  'inv.guard_item_category_no_cycle',
  'inv.guard_item_identifier',
  'inv.guard_item_lifecycle',
  'inv.guard_item_uom_scope',
  'inv.guard_material_request_ceiling',
  'inv.guard_material_request_fulfillment',
  'inv.guard_material_request_status',
  'inv.guard_material_requirement',
  'inv.guard_material_requirement_exception',
  'inv.guard_opening_batch_approval',
  'inv.guard_item_sale_price',
  'inv.guard_item_unit_conversion',
  'inv.guard_part_return_ceiling',
  'inv.guard_sales_return_ceiling',
  'inv.guard_stock_balance_coherence',
  'inv.guard_stock_count_status',
  'inv.guard_stock_location_hierarchy',
  'inv.guard_stock_movement_provenance',
  'inv.guard_stock_reservation_status',
  'inv.guard_stock_transfer_settlement',
  'inv.guard_stock_transfer_status',
  'inv.guard_vehicle_fluid_specification',
  'inv.issue_material_request',
  'inv.issue_part',
  'inv.item_identifier_is_well_formed',
  'inv.lock_material_request',
  'inv.lock_return_source',
  'inv.lock_stock_balance',
  'inv.material_requirement_usage',
  'inv.material_unit_gap',
  'inv.mod10_check_digit',
  'inv.normalize_item_identifier',
  'inv.open_stock_count',
  'inv.post_counter_sale_line',
  'inv.post_goods_receipt',
  'inv.post_stock_movement',
  'inv.propose_material_requirement',
  'inv.receive_sales_return',
  ...
  'inv.reject_material_requirement',
  'inv.release_reservation',
  'inv.request_material_exception',
  'inv.request_transfer_write_off',
  'inv.reserve_material_request',
  'inv.reserve_stock',
  'inv.resolve_item_sale_price',
  'inv.resolve_vehicle_fluid_specification',
  'inv.returnable_quantity',
  'inv.returned_quantity',
  'inv.retire_item_identifier',
  'inv.retire_item_unit_conversion',
  'inv.retire_vehicle_fluid_specification',
  'inv.return_part',
  'inv.return_transfer_remainder',
  'inv.set_item_sale_price',
  'inv.set_item_unit_conversion',
  'inv.supply_material_requirement_basis',
  'inv.sync_reserved',
  'inv.transfer_status_for',
  'inv.unit_conversion_factor',
  'org.assert_capacity_available',
  'org.capacity_limit',
  'org.capacity_usage',
  'org.capacity_used',
  ...
  'org.guard_subscription_charge_status',
  'org.guard_subscription_receipt_coherence',
  'org.guard_tenant_status_coherence',
  'org.guard_tenant_status_transition',
  'org.plan_capacity_shortfall',
  'org.provision_organization',
  'org.resolve_feature_enabled',
  'org.settle_subscription_charge',
  ...
  'quo.pin_quotation_discount_policy',
  'quo.quotation_discount_policy',
  'quo.guard_discount_request_item_freeze',
  'quo.backfill_discount_approvals',
  'quo.guard_revision_written_as_draft',
  ...
  'svc.guard_pricing_approval_policy_status',
  ...
  'svc.record_pricing_approval_policy_version',
  'svc.resolve_price',
...
describe('database foundation', () => {
  ...
  it('module-schema tables carry EXACTLY the approved triggers and policies', async () => {
    ...
    expect(triggers.rows.map((r) => r.tgname)).toEqual([
      ...
      'tg_delivery_records_delivering_employee',
      ...
      'tg_discount_approvals_guard',
      'tg_discount_approvals_immutable',
      'tg_discount_approvals_touch_metadata',
      ...
      'tg_duplicate_candidates_touch_metadata',
      'tg_employees_immutable',
      'tg_employees_touch_metadata',
      ...
      'tg_goods_receipt_lines_immutable',
      'tg_goods_receipt_lines_touch_metadata',
      ...
      'tg_item_identifiers_guard',
      'tg_item_identifiers_immutable',
      'tg_item_identifiers_touch_metadata',
      ...
      'tg_item_sale_prices_touch_metadata',
      'tg_item_unit_conversions_guard',
      'tg_item_unit_conversions_immutable',
      'tg_item_unit_conversions_touch_metadata',
      ...
      'tg_material_request_fulfillments_guard',
      'tg_material_requests_ceiling',
      'tg_material_requests_immutable',
      'tg_material_requests_status',
      'tg_material_requests_touch_metadata',
      'tg_material_requirement_exceptions_guard',
      'tg_material_requirement_exceptions_immutable',
      'tg_material_requirement_exceptions_touch_metadata',
      'tg_material_requirements_guard',
      'tg_material_requirements_immutable',
      'tg_material_requirements_touch_metadata',
      ...
      'tg_pricing_approval_policies_record_version',
      'tg_pricing_approval_policies_status',
      'tg_pricing_approval_policies_touch_metadata',
      'tg_pricing_approval_policies_version_immutable',
      ...
      'tg_sales_returns_ceiling',
      'tg_sales_returns_immutable',
      'tg_sales_returns_touch_metadata',
      ...
      'tg_stock_count_lines_immutable',
      'tg_stock_count_lines_touch_metadata',
      'tg_stock_counts_immutable',
      'tg_stock_counts_status',
      'tg_stock_counts_touch_metadata',
      ...
      'tg_stock_reservations_material_draw',
      'tg_stock_reservations_status',
      'tg_stock_reservations_touch_metadata',
      'tg_stock_transfer_settlements_guard',
      'tg_stock_transfer_settlements_immutable',
      'tg_stock_transfer_settlements_touch_metadata',
      'tg_stock_transfers_immutable',
      'tg_stock_transfers_status',
      'tg_stock_transfers_touch_metadata',
      'tg_storage_locations_immutable',
      'tg_storage_locations_parent_warehouse_live',
      'tg_storage_locations_touch_metadata',
      'tg_subscription_charges_immutable',
      'tg_subscription_charges_status_graph',
      'tg_subscription_charges_touch_metadata',
      'tg_subscription_plans_immutable',
      'tg_subscription_plans_touch_metadata',
      'tg_subscription_plans_validate_documents',
      'tg_subscription_receipts_coherence',
      'tg_subscription_receipts_settle',
      ...
      'tg_vehicle_fluid_specifications_guard',
      'tg_vehicle_fluid_specifications_immutable',
      'tg_vehicle_fluid_specifications_touch_metadata',
    ...
    expect(policies.rows.map((r) => r.polname)).toEqual([
      ...
      'ins_branches_capacity_authority',
      'ins_branches_platform',
      'ins_branches_platform_manage',
      'ins_branches_scope',
      ...
      'ins_goods_receipt_lines_scope',
      'ins_goods_receipts_scope',
      ...
      'ins_item_cost_layers_gated',
      'ins_item_identifiers_tenant',
      'ins_item_master_tenant',
      'ins_item_reorder_levels_scope',
      'ins_item_sale_prices_scope',
      'ins_item_unit_conversions_tenant',
      ...
      'ins_legal_companies_capacity_authority',
      'ins_legal_companies_platform',
      'ins_legal_companies_platform_manage',
      'ins_legal_companies_tenant',
      'ins_login_audit_self',
      'ins_makes_tenant',
      'ins_material_request_fulfillments_scope',
      'ins_material_requests_scope',
      'ins_material_requirement_exceptions_scope',
      'ins_material_requirements_scope',
      ...
      'ins_role_grants_platform_manage',
      ...
      'ins_roles_platform_manage',
      'ins_sales_returns_scope',
      ...
      'ins_stock_count_lines_scope',
      'ins_stock_counts_scope',
      'ins_stock_locations_scope',
      'ins_stock_movements_scope',
      'ins_stock_reservations_scope',
      'ins_stock_transfer_settlements_scope',
      'ins_stock_transfers_scope',
      'ins_storage_locations_scope',
      'ins_subscription_charges_platform',
      'ins_subscription_plans_platform',
      'ins_subscription_receipts_platform',
      ...
      'ins_tenant_subscription_events_platform',
      'ins_tenant_subscriptions_platform',
      'ins_tenant_subscriptions_platform_admin',
      ...
      'ins_user_accounts_platform_manage',
      ...
      'ins_vehicle_fluid_specifications_tenant',
      ...
      'sel_branches_platform_console',
      'sel_branches_platform_growth',
      'sel_branches_scope',
      ...
      'sel_item_cost_layers_gated',
      'sel_item_identifiers_tenant',
      'sel_item_master_tenant',
      'sel_item_reorder_levels_tenant',
      'sel_item_sale_prices_tenant',
      'sel_item_unit_conversions_tenant',
      ...
      'sel_legal_companies_platform_console',
      'sel_legal_companies_platform_growth',
      ...
      'sel_login_audit_own',
      'sel_makes_visible',
      'sel_material_request_fulfillments_scope',
      'sel_material_requests_scope',
      'sel_material_requirement_exceptions_scope',
      'sel_material_requirements_scope',
      ...
      'sel_role_grants_platform_manage',
      'sel_role_grants_tenant',
      'sel_role_permissions_tenant',
      'sel_roles_platform_manage',
      'sel_roles_tenant',
      'sel_sales_returns_scope',
      ...
      'sel_stock_count_lines_scope',
      'sel_stock_counts_scope',
      'sel_stock_locations_scope',
      'sel_stock_movements_scope',
      'sel_stock_reservations_scope',
      'sel_stock_transfer_settlements_destination',
      'sel_stock_transfer_settlements_scope',
      'sel_stock_transfers_destination',
      'sel_stock_transfers_scope',
      'sel_storage_locations_scope',
      'sel_subscription_charges_platform',
      'sel_subscription_plans_platform',
      'sel_subscription_plans_platform_console',
      'sel_subscription_plans_platform_manage',
      'sel_subscription_plans_published',
      'sel_subscription_receipts_platform',
      ...
      'sel_tenant_status_history_platform',
      'sel_tenant_status_history_tenant',
      'sel_tenant_subscription_events_platform',
      'sel_tenant_subscription_events_tenant',
      'sel_tenant_subscriptions_platform',
      'sel_tenant_subscriptions_platform_console',
      'sel_tenant_subscriptions_platform_manage',
      'sel_tenant_subscriptions_tenant',
      'sel_tenants_platform',
      'sel_tenants_platform_manage',
      'sel_tenants_self',
      ...
      'sel_user_accounts_platform_census',
      'sel_user_accounts_platform_growth',
      ...
      'sel_vehicle_fluid_specifications_tenant',
      ...
      'upd_goods_receipt_lines_scope',
      'upd_goods_receipts_scope',
      ...
      'upd_item_identifiers_tenant',
      'upd_item_master_tenant',
      'upd_item_reorder_levels_scope',
      'upd_item_sale_prices_scope',
      'upd_item_unit_conversions_tenant',
      ...
      'upd_makes_tenant',
      'upd_material_requests_scope',
      'upd_material_requirement_exceptions_scope',
      'upd_material_requirements_scope',
      ...
      'upd_stock_count_lines_scope',
      'upd_stock_counts_scope',
      'upd_stock_locations_scope',
      'upd_stock_reservations_scope',
      'upd_stock_transfer_settlements_scope',
      'upd_stock_transfers_scope',
      'upd_storage_locations_scope',
      'upd_subscription_charges_platform',
      'upd_subscription_plans_platform',
      ...
      'upd_template_versions_tenant',
      'upd_tenant_subscriptions_platform_admin',
      ...
      'upd_vehicle_fluid_specifications_tenant',
