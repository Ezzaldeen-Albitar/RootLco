...
describe('every operation publishes the success status it returns', () => {
  ...
  it('still finds the population that made this necessary', () => {
    ...
    // 285 with the P1-31 report engine (P-11): one GET returning 200, with 201 and
    // 202 unchanged. A run operation that had smuggled a write in beside the read
    // would move the 201 count and this pair is where it would show.
