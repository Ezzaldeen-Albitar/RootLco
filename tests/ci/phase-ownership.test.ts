...
describe('PRE-P1-29 ownership — an initiative that spans the product, in lanes that do not', () => {
  ...
  const MATRIX: [string, string, boolean][] = [
    ...
    ['p1-30-frontend', 'apps/web/src/features/quotations/quotation-detail.tsx', true],
    ['p1-30-frontend', 'apps/web/tests/quotations.test.ts', true],
    ['p1-30-frontend', 'docs/phase-1/phase-1-30/a0-read-surface-matrix.md', true],
    ['p1-30-frontend', 'scripts/ci/check-p1-30-server-arithmetic.mjs', true],
    ['p1-30-frontend', 'apps/api/src/app/api/v1/quotations/route.ts', false],
    ['p1-30-frontend', 'apps/web/src/lib/api/idempotent-operations.ts', false],
    ['p1-30-frontend', 'supabase/seeds/04_iam_permission_catalog.sql', false],
    ['p1-30-frontend', 'supabase/migrations/20260910090000_anything.sql', false],
    ['p1-30-backend', 'apps/api/src/app/api/v1/quotations/route.ts', true],
    ['p1-30-backend', 'apps/api/src/modules/quotation/application/quotation-service.ts', true],
    ['p1-30-backend', 'supabase/seeds/04_iam_permission_catalog.sql', true],
    ['p1-30-backend', 'apps/web/src/lib/api/idempotent-operations.ts', true],
    ['p1-30-backend', 'tests/backend/p1-30-quotation-list.test.ts', true],
    ['p1-30-backend', 'apps/web/src/features/quotations/quotation-detail.tsx', false],
    ['p1-30-backend', 'apps/web/src/features/appointments/appointments-contract.ts', false],
    ['p1-30-backend', 'supabase/config.toml', false],
